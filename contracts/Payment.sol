...
contract Payment{
    DSGDToken private dsgdToken;
    address public owner;

    constructor(address _tokenAddress){
        owner = msg.sender;
        dsgdToken = DSGDToken(_tokenAddress); // Initialize DSGD token contract
    }
    ...
    //Pay a Request
    function payRequest(uint256 _request) public {
        ...
        require(dsgdToken.transferFrom(msg.sender, payableRequest.requestor, toPay), "Transfer failed");
